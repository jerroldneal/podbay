...
; (function () {
  ...
  ; (function () {
    ...
    function resolvePath(requestPath, fromPath) {
      // Check PodBay dynamic module URL registry (populated by bundle assembler for cache:false lib modules)
      if (window.__podbayModuleUrls && window.__podbayModuleUrls[requestPath]) {
        return window.__podbayModuleUrls[requestPath];
      }
