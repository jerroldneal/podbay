 ...
 *
 * Usage:
 *   var tw = require('table-watcher');
 *   tw.snapshot()    — raw scene data
...
var isLobby = params.get('windowType') === '1';
...
var tableWatcher = {
  snapshot: function () {
    if (isLobby) return { error: 'table watcher does not run on lobby windows' };
